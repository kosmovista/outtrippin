class ExpertEdit
  ...
  EXPERT_ATTRIBUTES = %w(countries cities style bio website paypal rss instagram google hometown current_location facebook twitter story travel_hack pinterest)
